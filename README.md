...
For another project I'm working on (https://github.com/evelynmitchell/connesLean), Plancharel is needed to prove a central part.

It's not in mathlib.

The other project needs the following, and I'd like  to do an implementation of Plancharel.
